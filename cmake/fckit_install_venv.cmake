...
macro( fckit_install_venv )
    ...
    execute_process( COMMAND ${Python3_EXECUTABLE} -m pip --disable-pip-version-check
                     install ${PIP_OPTIONS} ${CMAKE_CURRENT_SOURCE_DIR}/contrib/ruamel.yaml.clib-0.2.12 OUTPUT_QUIET )
    execute_process( COMMAND ${Python3_EXECUTABLE} -m pip --disable-pip-version-check
    ...
    execute_process( COMMAND ${Python3_EXECUTABLE} -m pip install --disable-pip-version-check
                     ${PIP_OPTIONS} ${CMAKE_CURRENT_SOURCE_DIR}/contrib/fypp-3.2-b8dd58b-20230822 OUTPUT_QUIET )
